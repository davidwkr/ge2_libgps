#!/bin/sh
# SL8541E GNSS Standalone Fix - CLARO ARGENTINA Edition
# No external dependencies required.

echo "--- Starting standalone GNSS Fix (Claro Argentina) ---"
...
if [ "$NUMERIC" != "722310" ]; then
    echo "[WARNING] Detected carrier ($NUMERIC) is NOT Claro Argentina (722310)."
    echo "This script is specifically tuned for Claro. Proceeding anyway..."
fi
...
<SPRDGNSS>
    <COMM>
        <PROTOCOL NAME="RX_SUPL_PROTOCOL" TYPE="SUPL" INTERFACE="seth_lte0">
          ...
          <PROPERTY NAME="CELL-ID-GSM-MCC" VALUE="722"/>
          <PROPERTY NAME="CELL-ID-GSM-MNC" VALUE="310"/>
