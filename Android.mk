...
ifeq ($(strip $(GNSS_CLR_FUNC)),true)
LOCAL_CFLAGS += -DGNSS_CPNI2UPSI
endif

ifeq ($(TARGET_BUILD_VARIANT),user)
LOCAL_CFLAGS += -DGNSS_NODEBUG
endif
LOCAL_CFLAGS += -DGNSS_ANDROIDN -DGNSS_LCS
LOCAL_CFLAGS +=  -Wall -Wno-missing-field-initializers  -Wunreachable-code -Wpointer-arith -Wshadow -Wno-error=date-time 
